...
AddressController.prototype.getAddressSummary = function(address, options, callback) {
  this.node.getAddressSummary(address, options, function(err, summary) {
    ...
    var transformed = {
      ...
      unconfirmedSent: summary.unconfirmedSpent / 1e8,
      unconfirmedSentSat: summary.unconfirmedSpent,
      unconfirmedReceived: summary.unconfirmedReceived / 1e8,
      unconfirmedReceivedSat: summary.unconfirmedReceived,
