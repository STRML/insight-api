...
// Same as AddressHistory.MAX_ADDRESS_QUERIES
var MAX_ADDRESS_QUERIES = 20;
...
AddressController.prototype.showMany = function(req, res) {
  var options = {
    noTxList: parseInt(req.query.noTxList)
  };

  async.eachLimit(req.addrs, MAX_ADDRESS_QUERIES, function(addr, next) {
